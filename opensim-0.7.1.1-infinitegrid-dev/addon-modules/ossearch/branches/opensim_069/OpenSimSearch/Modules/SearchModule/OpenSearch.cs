...
namespace OpenSimSearch.Modules.OpenSearch
{
    public class OpenSearchModule : IRegionModule
    {
        ...
        //This does not appear to be honouring the "Show in search" profile flag.
        //With that flag off, only show avatar name, born date, and account type.
        ...
        public void ClassifiedInfoRequest(UUID queryClassifiedID, IClientAPI remoteClient)
        {
            ...
            if (dataArray.Count == 0)
            {
                // Something bad happened here. If we could return an event
                // after the search, we should be able to find it here.
                // TODO do some (more) sensible error-handling here
